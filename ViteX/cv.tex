...
%	BIBLIOGRAPHY
%-------------------------------------------------------------------------------
\addbibresource{cv/publications.bib}  %Fixed terminology: 'references'(.tex) is reserved for references, not for publication bibliography.}
